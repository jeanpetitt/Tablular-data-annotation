...
def argsparser():
    ...
    parser.add_argument("--model_id", type=str,
                        required=True, help="Name of the base model", default="meta-llama/Llama-2-7b")
    parser.add_argument("--dataset", type=str,
                        default="yvelos/semantic_annotation", help="dataset used to train model")
    parser.add_argument("--hf_rep", type=str,
                        default="yvelos/Annotator_2_Llama", help="huggingFace repository for the fine tuned model")
